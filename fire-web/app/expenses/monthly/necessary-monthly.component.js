System.register(['@angular/core', '../../application/service/date-generator.service'], function(exports_1, context_1) {
    ...
    return {
        ...
        execute: function() {
            NecessaryMonthlyComponent = class NecessaryMonthlyComponent {
            ...
            NecessaryMonthlyComponent = __decorate([
                core_1.Component({
            ...
            exports_1("NecessaryMonthlyComponent", NecessaryMonthlyComponent);
        }
    }
});
//# sourceMappingURL=necessary-monthly.component.js.map